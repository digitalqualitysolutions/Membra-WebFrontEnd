 ...
 * `GET /clubs/languages` is the API's only catalogue of them, and it serves
 * a club's languages and a member's preferred one alike. A profile has nothing
 * to do with clubs; the shared table is the API's arrangement, not ours.
 *
